#define NGX_CONFIGURE " --prefix=/opt/nginx --sbin-path=/opt/nginx/sbin/nginx --conf-path=/opt/nginx/conf/nginx.conf --with-http_stub_status_module --with-http_gzip_static_module --with-stream"
...
#define NGX_CONF_PREFIX  "/opt/nginx/conf/"
#endif


#ifndef NGX_SBIN_PATH
#define NGX_SBIN_PATH  "/opt/nginx/sbin/nginx"
#endif


#ifndef NGX_CONF_PATH
#define NGX_CONF_PATH  "/opt/nginx/conf/nginx.conf"
#endif
